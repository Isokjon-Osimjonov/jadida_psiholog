...
const expectedResults = [
  ...
  },
  {
    ...
    description:
      "qaynonangiz bilan ziddiyatlarni sokin yo'l bilan hal qila olasiz.",
  },
  {
    title: "Ishonchni tiklash:",
    description:
      "xiyonat soyasidan chiqib, qadriyatlaringizni qayta tiklaysiz.",
  },
  {
    title: "Mehribon tarbiya:",
    description:
      "bolalarga baqirish o'rniga sokin, barqaror muloqot yo'lga qo'yiladi.",
  },
  {
    title: "Iliqlikni qaytarish:",
    description:
      "sovuqlik asta-sekin o'rnini iliqlik va yaqinlikka bo'shatadi.",
  },
  {
    title: "Aniq yo'l xaritasi:",
    description:
      "14 kunlik reja bilan qaysi qadamni qachon tashlashni bilib borasiz.",
  },
];
...
export const Desktop = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const webhookUrl = 'https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjYwNTY1MDYzNTA0MzU1MjY1NTUzZDUxMzYi_pc';
    ...
    <div className="bg-white min-h-screen w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="w-full mb-8 sm:mb-12 lg:mb-16">
          <div className="relative w-full h-[400px] sm:h-[500px] lg:h-[604px] bg-[url(/firefly-20250905201821-1.png)] bg-cover bg-center rounded-2xl sm:rounded-3xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 via-black/40 to-transparent rounded-2xl sm:rounded-3xl">
              <div className="flex flex-col justify-between h-full p-4 sm:p-6 lg:p-8">
                {/* Header */}
                <header className="w-full bg-[#369186] rounded-2xl sm:rounded-3xl p-4 sm:p-5">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h2 className="text-white font-medium text-lg sm:text-xl lg:text-2xl xl:text-[28px] [-webkit-text-stroke:1px_#ffffff] sm:[-webkit-text-stroke:2px_#ffffff]">
                      Jadida Xusniddinovna
                    </h2>
                    <Button className="w-full sm:w-auto bg-[#2ec492] hover:bg-[#2ec492]/90 rounded-[10px] px-4 sm:px-6 py-2 sm:py-3.5">
                ...
                <div className="flex-1 flex flex-col justify-center px-2 sm:px-4 lg:px-8">
                  <h1 className="text-white font-bold text-2xl sm:text-3xl lg:text-4xl xl:text-5xl leading-tight mb-4 sm:mb-6 lg:mb-8">
                    Qanday qilib ajrashish yoqasiga kelib qolgan munosabatlaringizni
                  ...
                  <p className="text-white font-medium text-sm sm:text-base lg:text-lg max-w-2xl leading-relaxed">
                    Ha, agar siz muammoning ildizini aniqlab, to'g'ri muloqot va
                    aniq reja bilan harakat qilsangiz.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-[#369186] font-bold text-2xl sm:text-3xl lg:text-4xl text-center mb-8 sm:mb-12 px-4">
            Ko'plab ayollar menga shunday muammolar bilan kelishadi
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
            {problemCards.map((card, index) => (
              <Card
                key={index}
                className="bg-[#ade2d7] rounded-2xl border-none p-4 sm:p-6"
              >
          ...
          <Card className="bg-[#379286] rounded-2xl sm:rounded-3xl border-none p-6 sm:p-8 lg:p-12">
            <CardContent className="p-0 text-center">
              <p className="text-white font-semibold text-xl sm:text-2xl lg:text-3xl leading-relaxed">
                Sizda ham shunday oilaviy muammo bo'lsa, bugun siz bilan bu
                muammoyingizga albatta yechim topamiz.
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-[#369186] font-bold text-2xl sm:text-3xl lg:text-4xl text-center mb-8 sm:mb-12 px-4">
            Keling avval aynan shu muammolar bilan oldimga kelgan bir ayolni
            hikoyasini aytib beraman.
          </h2>
          ...
          <Card className="rounded-2xl sm:rounded-3xl border border-[#224d49] p-6 sm:p-8 lg:p-12">
            <CardContent className="p-0">
              <p className="text-black font-light text-base sm:text-lg lg:text-xl xl:text-[22px] leading-relaxed">
                Bugun yana kechasi soat uchgacha uxlamadim. Yonimda erimni
                nafasini eshityapman. Qanday qilib u bunday uxlay oladi? Men esa
                har kuni o'zimni yolg'iz va tushunarsiz his qilaman.
                <br />
                <br />U bugun ishdan juda kech keldi, lekin nega menga aytmadi?
                Yoki u boshqasini topdimi?
                <br />
                <br />
                Ba'zida u bilan bir xonada bo'lsak ham, bir yostiqqa bosh qo'yib
                uxlasak ham o'rtamizda katta devor bordek.
                <br />
                <br />
                Dugonamga telegramdan dardimni yozdim."Uni kechir yoki ket," dedi.
                Agar kechirsam o'zimni aldashim kerak bo'ladi, ketsam butun oilam
                buziladi.
                <br />
                <br />
                Ba'zida erimga qarab, bir paytlar sevgan insonimni ko'raman. Lekin
                oilamizdagi og'riqlar meni har kuni sindirib boryapti:
                <br />
                <br />
                -Yonma-yon yotamiz, lekin birga gaplashmaymiz.
                <br />
                -Qaynonaming har bir ayb topishi, tanbehi menga o'zimni qadrsiz va
                ojiza his qildiradi.
                <br />
                -Erim gapimni eshitmaydi, fikrimni tushunmaydi, gapirsam so'kib
                beradi.
                <br />
                ...
                <br />
                -Bolalarimni bekordan-bekor urishib yuboraman. Aslida alamimni
                ulardan olaman. Keyin esa o'zimni yomon ko'rib yig'lab yuboraman.
                <br />
                <br />
                ...
                <br />
                <br />
                Ular menga "unut" yoki "kechir" demadilar. Ular menga aniq rejani
                berdilar.
                <br />
                <br />
                Erim meni qadrlashni, e'tibor berishni boshladi har hafta dam
                olish kuni bolalarim bilan aylanishga olib chiqadigan bo'ldi.
                <br />
                <br />
        ...
        <Card className="bg-[#ade2d7] rounded-2xl sm:rounded-3xl border-none p-6 sm:p-8 lg:p-12 mb-8 sm:mb-12 lg:mb-16">
          <CardContent className="p-0 text-center">
            <p className="text-[#224d49] font-medium text-lg sm:text-xl lg:text-2xl xl:text-[28px] leading-relaxed mb-4">
              Yuqorida hikoya qilgan ayol ham xuddi shu og'riqlarda yashardi. Bu
              ayol bilan birga ishlaganimizdan so'ng u barcha muammolaridan
              qutildi, natijasini esa o'zingiz ko'rib turibsiz.
            </p>
            ...
            {consultationBenefits.map((benefit, index) => (
              ...
              >
                <CardContent className="p-0 flex items-start gap-4">
                  ...
                  <p className="text-[#224d49] text-base sm:text-lg leading-relaxed flex-1">
                    {benefit.text}
                  </p>
                </CardContent>
              </Card>
        ...
        {/* Expected Results */}
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-[#379286] font-bold text-2xl sm:text-3xl lg:text-4xl text-center mb-8 sm:mb-12 px-4">
                  ...
                  <div className="flex-1">
                    <p className="text-[#224d49] text-base sm:text-lg lg:text-xl xl:text-[22px] leading-relaxed">
                      <span className="font-bold">
                        ...
                        {result.title === "Mehribon tarbiya:" ||
                        result.title === "Iliqlikni qaytarish:" ? (
                          <br />
                        ) : (
                          " "
                        )}
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <div className="relative">
            {guaranteeItems.map((item, index) => (
              <Card
                key={index}
                className={`bg-[#ade2d7] rounded-2xl sm:rounded-3xl border-none p-6 sm:p-8 mb-6 ${
                  index === 1 ? "ml-4 sm:ml-8 lg:ml-16" : 
                  index === 2 ? "ml-0" : ""
                }`}
              >
          ...
          {/* Pricing */}
          <div className="text-center lg:text-right lg:pr-8 xl:pr-16 mt-8 sm:mt-12">
            <p className="text-[#efa795] font-medium text-2xl sm:text-3xl lg:text-4xl leading-tight mb-4 sm:mb-8">
            ...
            <p className="text-[#369186] font-normal text-2xl sm:text-3xl lg:text-4xl leading-tight">
              <span className="font-medium">Bugun esa sizda uni atigi </span>
              <span className="font-bold">499 ming</span>
              <span className="font-medium"> so'mga olish imkoniyati bor!</span>
            </p>
          </div>
        </section>
        ...
        <Card className="bg-[#379286] rounded-2xl sm:rounded-3xl border-none p-6 sm:p-8 lg:p-12 mb-8 sm:mb-12">
          <CardContent className="p-0 flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
            ...
            <p className="text-white text-lg sm:text-xl lg:text-2xl xl:text-[28px] leading-relaxed flex-1">
              Har kim ham bu imkoniyatdan foydalana olmaydi. Avval men siz bilan
              gaplashaman va muammoingizni tushunib chiqaman. Agar haqiqatan
              yordam bera olishimga ishonsam, keyin sizni 499 ming so'mga
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                ...
                <p className="text-white text-lg sm:text-xl lg:text-2xl leading-relaxed">
                  Ismingiz va telefon raqamingizni yozib qoldiring birinchi
                  suhbatimiz bepul bo'ladi.
                </p>
              </div>
